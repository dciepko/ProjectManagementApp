--  INSERT INTO user (userid, user_first_name, user_surename, user_nickname, user_email, user_password, working_hours, is_owner, role) VALUES (1, 'Marianna', 'Nowakowska', 'Mariankan', 'marianna@example.com', 'password123', '10-18', FALSE, 2);

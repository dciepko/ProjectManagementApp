 ...
 INSERT INTO attachement (attachementid, attachement_name, attachement_type, attachement_url, date, activityid, userid) VALUES (3, 'zalacznik3', 'link', 'example.com', '2024-03-21', 3, 3);
 ...
 INSERT INTO comment (commentid, comment, comment_date, activityid, userid) VALUES (1, 'komentarz 1', '2024-03-21', 1, 1);
 ...
 INSERT INTO project (projectid, end_date, ownerid, project_description, project_name, start_date, statusid, tableid, teamid) VALUES(1, '2024-03-21', 1, 'description 1', 'Projekt1', '2024-03-21', 1, 1, 1);
 INSERT INTO project (projectid, end_date, ownerid, project_description, project_name, start_date, statusid, tableid, teamid) VALUES(2, '2024-03-21', 1, 'description 2', 'Projekt2', '2024-03-21', 2, 2, 2);
 INSERT INTO project (projectid, end_date, ownerid, project_description, project_name, start_date, statusid, tableid, teamid) VALUES(3, '2024-03-21', 1, 'description 3', 'Projekt3', '2024-03-21', 3, 3, 3);
